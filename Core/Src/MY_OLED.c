...
void three_phase_inverter_interface_head(void) {
    ...
    OLED_ShowString(64,0,"vdc:",OLED_6X8);
...
void three_phase_inverter_interface_main(void) {
    ...
    OLED_ShowFloatNum(88,0,vdc_measurement,2,3,OLED_6X8);
...
void DeBug_interface_head(void) {
    ...
    OLED_ShowString(0,48,"vdc:",OLED_6X8);
    OLED_ShowString(0,56,"EC_DeBug:",OLED_6X8);

    OLED_Update();
}
void DeBug_interface_main(void) {
    OLED_ShowFloatNum(18,24,S.vm,2,3,OLED_6X8);
    ...
    OLED_ShowFloatNum(24,48,SVPWM1.vdc,2,2,OLED_6X8);
    ...
    switch (now_EC_DeBug) {
        ...
        case vdc_:
            OLED_ClearArea(54,56,72,8);
            OLED_ShowString(54,56,"vdc_",OLED_6X8);
            break;
        default:
            break;
    }
